...
class Map {
public:
    const static int mapHeight = 300;/* predefined */
    const static int mapWidth = 150; /* predefined */
...
private:
    ...
    /* #### MaptoGrid function and convert the map to 1's and 0's #### */
    ...
    /* #### Function to generate a Manhttan Heuristic Vector #### */
...
class Planner : Map {
public:
    int start[2] =  {230, 145}; /* predefined */
    int goal[2] = { 60, 50 };   /* predefined */
    int cost = 1;
