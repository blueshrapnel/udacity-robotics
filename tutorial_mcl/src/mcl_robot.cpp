#include "src/matplotlib.cpp.h" // graph library
#include <iostream>
#include <string>
#include <math.h>
#include <vector>
#include <stdexcept>  // throw errors
#include <random>     // C++ random numbers
...
// global functions
double mod(double first_term, second_term);
doube gen_real_random();
...
public:
    ...
    String show_pose()
    {
        // return the robot's current position and orientation in a string format
    ...
    {
        // calculate how likely a measurement would be
        double prob = 1.0;
        double dist;
    ...
    double x, y, orient; // robot pose variables
    double forward_noise, turn_noise, sense_noise; // robot noise variables
